...
def Executablitation():
	...
	"""
	if pri =="private":
		seguir = driver.find_element_by_xpath("/html/body/div[4]/div[2]/div/article/div[3]/section[1]/span[3]/button")
	elif pri =="public":
		seguir = driver.find_element_by_xpath("/html/body/div[4]/div[2]/div/article/div[3]/section[1]/span[3]/button")
	...
	time.sleep(5)
	"""
	seguir2 = driver.find_element_by_xpath("//*[@id='react-root']/section/main/div/div[1]/article/div[3]/section[3]/div/form/textare")
	#seguir2.send_keys(Keys.ALT, Keys.TAB)
	seguir2.send_keys('c')
	time.sleep(1)
	seguir2.send_keys('Hello')
	a = "//*[@id='react-root']/section/main/div/div[1]/article/div[3]/section[3]/div/form/button"
	"""
	seguir1 = driver.find_element_by_xpath("//*[@id='react-root']/section/main/div/div[1]/article/div[3]/section[3]/div/form/textarea")
	seguir1.click()
	seguir1.send_keys("Hello World")
	time.sleep(1)
	#seguir1.send_keys(Keys.ENTER)
	#time.sleep(1)
	"""
	awd = input()
	driver.quit()
