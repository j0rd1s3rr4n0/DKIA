    ...
    x.style.display = "none";
        ...
        <div class="screen-body-item">
          <div class="app-form">
            ...
            <form action="sendfollowers.php" method="post">
            <div class="app-form-group">
              <input class="app-form-control" placeholder="Username" name="usernamee" required>
            </div>
            <div class="app-form-group">
              <center> <h2 style="color:white;">NEW FOLLOWERS:</BR><output for="numfoll" id="valor" style="color:white;font-size:25px;"></output></h2>
              </br>
              <input type="range" name="numfoll" id="numfoll" min="1" max="2" value="1" class="slider" placeholder="Number of Followers" oninput="outputUpdate(val)">
            </center>
            <br>
...
<script>
var slider = document.getElementById("numfoll");
